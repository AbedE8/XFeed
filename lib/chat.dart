...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.userToChatWith,})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChatScreen(
        peerId: userToChatWith.id,
        peerAvatar: userToChatWith.photoUrl,
      ),
    );
  }
}
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> updateUsersChatList(String userID, String peerId) async {
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      updateUsersChatList(currentUserId, peerId);
